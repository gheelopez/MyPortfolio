...
const Contact = () => {
  ...
  const contacts = [
    {
      label: 'GitHub',
      url: 'https://github.com/gheelopez',
      icon: (
    ...
    {
      label: 'LinkedIn',
      url: 'https://www.linkedin.com/in/ghee-kaye-lopez',
      icon: (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      label: 'E-mail',
      email: 'lopez.gheekaye@gmail.com',
      icon: (
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <section id="contact" className="section">
      ...
      <div className="contact-intro">
        <p>Send me a message or connect through social media</p>
      </div>
        ...
        <div className="contact-grid">
          {contacts.map((contact, index) => (
            contact.url ? (
              ...
              <div className="contact-card contact-card-email" key={index}>
                <div className="contact-card-content">
                  <div className="contact-card-icon">{contact.icon}</div>
                  <div className="contact-card-info">
                    <div className="contact-card-label">{contact.label}</div>
                    <div className="contact-card-email-address">{contact.email}</div>
                  </div>
                </div>
              </div>
            )
